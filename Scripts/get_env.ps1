...
AZURE_PG_NAME=cases
AZURE_PG_USER=$($aadUserPrincipalName)
AZURE_PG_PASSWORD=replace_with_token
AZURE_PG_PORT=5432
...
Write-Output ""
Write-Output ""
Write-Output "For Part 1 of the lab, here are the needed configurations:"
Write-Output ""
Write-Output "Configuration retrieved:"
Write-Output "  Azure OpenAI Endpoint: $openaiEndpoint"
Write-Output "  Azure OpenAI Key: $openaiKey"
Write-Output ""
Write-Output "Helper SQL Commands for Part 1:"
Write-Output ""
Write-Output "  SELECT azure_ai.set_setting('azure_openai.endpoint', '$($openaiEndpoint)');"
Write-Output ""
Write-Output "  SELECT azure_ai.set_setting('azure_openai.subscription_key', '$($openaiKey)');"
Write-Output ""

Write-Output ""
Write-Output ""

Write-Output "For Part 3 of the lab, your .env file is created successfully at: $envFilePath"
Write-Output ""
Write-Output "Configuration retrieved:"
Write-Output "  Azure OpenAI Endpoint: $openaiEndpoint"
...
Write-Output "  PostgreSQL User: $aadUserPrincipalName"
Write-Output ""
Write-Output ""
